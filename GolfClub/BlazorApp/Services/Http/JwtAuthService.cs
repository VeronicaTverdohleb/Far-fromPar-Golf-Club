...
public class JwtAuthService : IAuthService
{
    ...
    /* We need a method to create a ClaimsPrincipal. Remember, this
     is the type of "User" object the Blazor auth-framework understands. 
     So the JWT is converted into a ClaimsPrincipal with the following method */
    ...
    public async Task LoginAsync(string username, string password)
    {
        ...
        HttpResponseMessage response = await client.PostAsync("https://localhost:7042/auth/login", content);
